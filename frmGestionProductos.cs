...
namespace Prototipo1
{
    public partial class frmGestionProductos : Form
    {
        ...
        {
            string CadSql;
            CadSql = "select nombre_prod,cod_interno,cod_barra, precio_costo, precio_venta,Stock from productos order by cod_barra ;";
            ...
            try
            {
                ...
                while (Rec.Read())
                {
                    ...
                    dgvLista.Rows[fila].Cells[5].Value = Rec["Stock"].ToString();
        ...
        private void buscatextchang()
        {
            string CadSql;
            CadSql = "select nombre_prod, cod_interno, cod_barra, precio_costo, precio_venta from productos like '%" + txtBuscar.Text + "%';";
        ...
        {
            string CadSql;
            CadSql = "select nombre_prod, cod_interno, cod_barra, precio_costo, precio_venta,Stock from productos where  " + dato + " like '%" + txtBuscar.Text + "%';";
        ...
        {
            String dato = this.dgvLista.CurrentRow.Cells["grdCodBarra"].Value.ToString();
            if (!dato.Equals("") || !dato.Equals(null))
            {
                frmActualizaStock l = new frmActualizaStock();
                l.dato = dato;
                l.Show();
                this.Hide();
            }
        ...
        {
            frmCajaTraspaso cjt = new frmCajaTraspaso();
            cjt.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            frmCajaIngreso cing = new frmCajaIngreso();
            cing.Show();
        }

        private void button4_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Opcion en prosceso de desarrollo");
            //new frmkit().ShowDialog();
        }
