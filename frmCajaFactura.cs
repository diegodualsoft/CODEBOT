...
{
    public partial class frmCajaFactura : Form
    {
        public frmCajaFactura()
        {
            InitializeComponent();
        }
        ...
        private void cmdSalir_Click(object sender, EventArgs e)
        {
            if (dgvLista.Rows.Count == 0)
            {
                ...
                claseBD cbd = new claseBD();
                string eliminarcaja = "truncate table caja_factura_1";
        ...
        private void ingresogrdcaja(KeyPressEventArgs e)
        {
            ...
            {       
                    ...
                    else
                    {
                        ...
                        try
                        {
                            string consultacaja = "select * from caja_factura_1 where nombre = '" + lblNombreprodCaptura.Text + "' ";
                            CBd.AbrirConexion();
                       ...
                       if (Codinterno == txtCodigoBarra.Text || codBarra == txtCodigoBarra.Text.Substring(0,7))
                        {
                            ...
                            if (lblNombreprodCaptura.Text == lblconsultacaja.Text)
                            {
                                ...
                                string updatecaja = "Update caja_factura_1 Set cod_barra = '" + lblCodBarraCaptura.Text + "',precio = '" + lblPrecioVentaCaptura.Text + "',cant = '" + Convert.ToDouble(rescant) + "',total = '" + totales.ToString() + "',costo = '" + rescost + "' , margen = '" + lblmargen.Text + "' where nombre = '" + lblconsultacaja.Text + "' ";
                            ...
                            {
                                string cadsql3 = "insert into caja_factura_1 values('" + lblNombreprodCaptura.Text + "','" + lblCodInternoCaptura.Text + "','" + lblCodBarraCaptura.Text + "','" + lblPrecioVentaCaptura.Text + "','" + Convert.ToDouble(cantcaptura) + "','" + total2.ToString() + "','" + totalcost + "','" + lblmargen.Text + "')";
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            try
            {
                ...
                string updatecaja = "delete from caja_factura_1 where cod_barra = '" + codBarra + "'";
                CBd.EjecutarIUD(updatecaja);
