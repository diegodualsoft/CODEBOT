    ...
    public partial class frmIngresoCLI : Form
    {
        ...
        private void cmdGuardar_Click_1(object sender, EventArgs e)
        {
            if (mskRUT.MaskCompleted)
            {
                ...
                string CadSql;
                CadSql = "insert into clientes values('" + rut2.ToUpper() + "','" + txtrazonsocial.Text.ToUpper() + "','" + txtgiro.Text.ToUpper() + "','" + txtNombre.Text.ToUpper() + "','" + txtDireccion.Text.ToUpper() + "','" + txtTelefono.Text.ToUpper() + "','"+txtcomuna.Text.ToUpper()+"','"+txtciudad.Text.ToUpper()+"','"+txtVendedor.Text.ToUpper()+"','"+txtNF.Text.ToUpper()+"');";
        ...
        private void mskRUT_Leave(object sender, EventArgs e)
        {
                ...
                if (mskRUT.MaskCompleted)
                {
                    ...
                    CadSql = "select razon_social, giro,nombres, direccion, telefono, ciudad,comuna,vendedor,NF from clientes where rut = '" + rut2 + "'";
